...
const RoyalKids: React.FC = () => {

    const offer = offersData.offer.find((x => x.subtitle === "Royal Kids Szczecin"))
            ...
            <section className={cx("cards-container offers", { 'offer-subpage': offer?.url && offer?.subtitle })}>
                <article>
                    ...
                    <div className="cards-subcontent">
                        <h1 className="cards-subcontent-title">Taniec dla dzieci Szczecin</h1>
