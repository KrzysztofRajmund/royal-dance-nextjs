...
const Latino: React.FC = () => {

    const offer = offersData.offer.find((x => x.subtitle === "Latino Solo dla Pań Szczecin"))
    ...
    return (
        <>
            <Meta
                webUrl={`https://www.royaldanceszczecin.pl/latino-solo-dla-pan`}
