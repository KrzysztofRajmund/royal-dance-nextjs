...
const DlaDoroslych: React.FC = () => {

    const offer = offersData.offer.find((x => x.subtitle === "Kurs Tańca dla Dorosłych Szczecin"))
    ...
    return (
        <>
            <Meta
                webUrl={`https://www.royaldanceszczecin.pl/kurs-tanca-dla-doroslych`}
