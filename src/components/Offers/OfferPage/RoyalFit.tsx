...
const RoyalFit: React.FC = () => {

    const offer = offersData.offer.find((x => x.subtitle === "Royal Fit"))
    ...
    return (
        <>
            <Meta
                webUrl={`https://www.royaldanceszczecin.pl/royal-fit`}
