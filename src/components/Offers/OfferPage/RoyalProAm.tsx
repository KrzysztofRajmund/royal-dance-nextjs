...
const RoyalProAm: React.FC = () => {

    const offer = offersData.offer.find((x => x.subtitle === "Royal Pro-Am"))
    ...
    return (
        <>
            <Meta
                webUrl={`https://www.royaldanceszczecin.pl/royal-pro-am`}
