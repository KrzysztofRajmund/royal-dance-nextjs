...
const RoyalSport: React.FC = () => {

    const offer = offersData.offer.find((x => x.subtitle === "Royal Sport"))
    ...
    return (
        <>
            <Meta
                webUrl={`https://www.royaldanceszczecin.pl/royal-sport`}
